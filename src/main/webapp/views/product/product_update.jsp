    ...
    <h2 align="center">상품 수정 페이지</h2>
        ...
        <form id="product_update" action="updateFinish.do" method="post">
            ...
            <table id="product_update_table">
                ...
                <tr id="product_update_enrollment">
                    ...
                    <td><input type="file" name="goods_image"  id="goods_image" alt="${product.image}" src="./img/product_img/${product.goods_image}"></td>
                ...
                <tr id="product_sale_enrollment">
                    ...
                    <td><input type="number" id="goods_quantity" name="goods_quantity" value="${product.goods_quantity}"></td>
                    <td><textarea rows="10" cols="60" style="resize: none;"  id="goods_detail" name="goods_detail">${product.goods_detail}</textarea></td>
                    <td>${loginuser.id}<input type='hidden' id="seller_id" name="seller_id"  value="${loginuser.id}" /></td>
                </tr>
                <tr id="product_sale_button">
                    <td colspan="4">
                        <input id="product_update_input" type="submit" alt="상품수정" value="상품수정" />
                    </td>
                </tr>
