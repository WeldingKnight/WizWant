...
public class QnaDAO {
	...
	private final String QNA_UPDATE ="update QNA_BOARD set user_id=?, qna_title=?, qna_content=? where qna_id=?";
	private final String QNA_DELETE ="delete QNA_BOARD where qna_id=?";
	private final String QNA_GET = "select * from QNA_BOARD order by qna_id desc";
